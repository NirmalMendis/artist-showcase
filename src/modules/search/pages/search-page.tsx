import { Box, Heading, Input, SimpleGrid, Spinner, Text, VStack } from '@chakra-ui/react';
...
const SearchPage = () => {
  ...
  return (
    <VStack gap={6} p={4} align="stretch">
      ...
      <Input placeholder="Search for albums or tracks..." value={searchText} onChange={(e) => setSearchText(e.target.value)} size="lg" />
